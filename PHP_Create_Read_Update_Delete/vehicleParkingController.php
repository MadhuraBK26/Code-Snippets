...

{
    ...
    {    
        if (isset($_POST)) {
            ...
            if (!$parkingResponse['status']) {
                ...
                //   session_unset($parkingResponse);
                //  session_destroy(errorArray);
    ...
    public function deleteParking()
    {
        ...
        if (!empty($_POST)) {
            ...
            if ($deleteResponse) header("Location:vehicleParkingController.php?act=parkingIndex");
        }
    }
    ...
    public function createLocation()
    {
        if (isset($_POST)) {
            ...
            if ($parkingResponse['status']) {
                ...
                if ($locResponse) header("Location:vehicleParkingController.php?act=createLocationView");
            }
        }
